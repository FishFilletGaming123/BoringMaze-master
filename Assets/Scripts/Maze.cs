...
public class Maze : MonoBehaviour
{
    ...
    public void DiamondRandomGeneration()
    {
    IntVector2 diamondCoordinates = RandomCoordinates;
    MazeCell diamondCell = GetCell(diamondCoordinates);
    if (diamondCell != null)
      {
         Vector3 diamondPosition = diamondCell.transform.position;
         diamondPosition.y += 0.4f;
         Quaternion diamondRotation = Quaternion.Euler(0, 0, 180);
         Instantiate(diamondPrefab, diamondPosition, diamondRotation);
      }
}
}
